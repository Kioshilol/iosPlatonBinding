...
final public class PlatonTransaction:NSObject, Decodable, PlatonCustomDescribe, PlatonAmountProtocol {
...
public class PlatonOrderModel: NSObject, PlatonCustomDescribe, PlatonStatusProtocol, Decodable {
    ...
    required public init(from decoder: Decoder) throws {
        customDescription = "";
        self.status = PlatonStatus.enabled
        self.date = ""
        self.orderId = ""
        self.transId = ""
...
final public class PlatonTransactionState: NSObject, PlatonCustomDescribe, Decodable {
