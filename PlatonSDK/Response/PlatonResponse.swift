...
@objc
public enum PlatonApplePayResponse: Int {
...
@objc(PlatonApplePayResponseWrapper)
public class PlatonApplePayResponseWrapper : NSObject{
    
    @objc
    public var responseEnum : PlatonApplePayResponse
    
    @objc
    public var platonBaseProtocol : PlatonBaseProtocol
    
    @objc
    public init(responseEnum: PlatonApplePayResponse, platonBaseProtocol: PlatonBaseProtocol) {
        
        self.responseEnum = responseEnum
        self.platonBaseProtocol = platonBaseProtocol
    }
}
