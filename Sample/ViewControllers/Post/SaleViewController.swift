        ...
        PlatonPostPayment.sale.sale(order: order,
                                    ...
                                    ext: ext) { (result) in
                                        ...
                                        case .recurringInit(let saleRecurring):
                                            UserDefaults.standard.setValue(saleRecurring.recurringToken, forKeyPath: PlatonMethodProperty.recurringToken.stringValue)
                                        ...
                                        UserDefaults.standard.setValue(transId, forKeyPath: PlatonMethodProperty.transId.stringValue)
                                        UserDefaults.standard.setValue(order.id, forKey: PlatonMethodProperty.orderId.stringValue)
